...
namespace UniversityManagementSystem.Views
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(VarsityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstMidName,HireDate")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstMidName,HireDate")] Lecturer lecturer)
        {
            if (id != lecturer.ID)
            {
                return NotFound();
